...
func (c *chatProxyClient) SayMessage(ctx context.Context, in *ChatRequest, opts ...grpc.CallOption) (*ChatReply, error) {
	...
	out := new(ChatReply)
	err := c.cc.Invoke(ctx, ChatProxy_SayMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatProxyClient) WsSayMessage(ctx context.Context, in *WsChatRequest, opts ...grpc.CallOption) (*WsChatReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WsChatReply)
	err := c.cc.Invoke(ctx, ChatProxy_WsSayMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedChatProxyServer must be embedded to have
...
func (UnimplementedChatProxyServer) testEmbeddedByValue()                   {}
...
func RegisterChatProxyServer(s grpc.ServiceRegistrar, srv ChatProxyServer) {
	// If the following call pancis, it indicates UnimplementedChatProxyServer was

...
func (c *nuwaServiceClient) Login(ctx context.Context, in *ReqUserLogin, opts ...grpc.CallOption) (*RespUserLogin, error) {
	...
	err := c.cc.Invoke(ctx, NuwaService_Login_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nuwaServiceClient) Logout(ctx context.Context, in *ReqUserLogout, opts ...grpc.CallOption) (*RespUserLogout, error) {
	...
	err := c.cc.Invoke(ctx, NuwaService_Logout_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nuwaServiceClient) GetUserSession(ctx context.Context, in *ReqUserSession, opts ...grpc.CallOption) (*RespUserSession, error) {
	...
	err := c.cc.Invoke(ctx, NuwaService_GetUserSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNuwaServiceServer must be embedded to have
...
func (UnimplementedNuwaServiceServer) testEmbeddedByValue()                     {}
...
func RegisterNuwaServiceServer(s grpc.ServiceRegistrar, srv NuwaServiceServer) {
	// If the following call pancis, it indicates UnimplementedNuwaServiceServer was
